                    ...
                    <div class="card full-height">
                        <div class="card-header">
                            <div class="card-head-row">
                                <div class="card-title">Form Merk</div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('merk.store') }}" method="POST" enctype="multipart/form-data">
                               ...
                               <div class="form-group">
                                    ...
                                    <input type="text" name="nama_merk" class="form-control" id="name"
                                        placeholder="Enter Nama Ruangan">
                                </div>
                                <div class="form-group">
                                    <label for="status">Status Merk</label>
                                    <textarea name="status_merk" id="editor">
                                    </textarea>
